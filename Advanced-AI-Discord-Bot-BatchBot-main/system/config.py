# IMPORTANT
#Discord Bot Token
TOKEN = "Token" # Grab your discord bot token at https://discord.com/developers/applications
#Gemini API KEY
API_KEY = "YOUR API" # Grab your gemini api key at https://aistudio.google.com/app/apikey
#Hugging Face API KEY
HUGGING_FACE_API = "Your API" # Grab your hugging face api key at https://huggingface.co/settings/tokens | (You can leave it but you will not have access to Image, music and object detection generation)
#Discord Bot's Name
NAME = "Ayash_BOT" # Change it to what you want to name the AI Bot | The AI bot will use the name for conversations and chats 
# Server Name
server_name = "SERVER" # Replace with your server name
# Creator Name
creator = "RSM" # You can edit it to your name.
...
# Web Search
web_search = True # Enable or disable web search   -- AIzaSyAFH7w3GdrzKSG5nZlRVlBqvnmFzEUEmcI  ---- AIzaSyAyBV448mL-T6zKT4r84Lc1L50sEvjjaYw
GOOGLE_CUSTOM_SEARCH_API_KEY = "API" # Grab your google custom search api key at https://developers.google.com/custom-search/docs/paid_element
GOOGLE_PROJECT_SEARCH_ENGINE_ID = "SEARCH ENGINE ID" # Grab your google project search engine id at https://programmablesearchengine.google.com/controlpanel/all
...
ffmpeg_executable_path = r"C:\Users\rajsh\Downloads\ffmpeg-7.0.2-full_build\ffmpeg-7.0.2-full_build\bin"  # Replace with the actual path to ffmpeg executable | Doesn't need to be an .exe file
